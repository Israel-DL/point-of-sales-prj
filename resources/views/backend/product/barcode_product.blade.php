                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a class="btn btn-blue rounded-pill waves-effect waves-light text-white" href="{{ route('all.product') }}">Back</a></li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="tab-pane" id="settings">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                <label for="name" class="form-label">Product Barcode</label>
