       ...
       <tr  class="text-center">
          ...
          <td colspan="3">
             <div class="switch-toggle switch-3 switch-candy">
                <input class="present" id="present{{$key}}" name="attendance_status{{$key}}" value="present" type="radio" {{ $item->attendance_status ==  'present' ? 'checked' : '' }} >
                <label for="present{{$key}}">Present</label>

                <input class="leave" id="leave{{$key}}" name="attendance_status{{$key}}" value="Leave" type="radio" {{ $item->attendance_status ==  'Leave' ? 'checked' : '' }} >
                <label for="leave{{$key}}">Leave</label>

                <input class="absent" id="absent{{$key}}" name="attendance_status{{$key}}" value="Absent" type="radio" {{ $item->attendance_status ==  'Absent' ? 'checked' : '' }} >
