                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <strong style="color: black;">{{ $paysalary->name }}</strong>
                                                            </div>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="name" class="form-label">Salary Month</label>
                                                                <strong style="color: black;">{{ date("F", strtotime('-1 month')) }}</strong>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <strong style="color: black;">{{ $paysalary->salary }}</strong>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="name" class="form-label">Advance/Already Paid Salary</label>
                                                                <strong style="color: black;">{{ $paysalary['advance']['advance_salary'] }}</strong>
