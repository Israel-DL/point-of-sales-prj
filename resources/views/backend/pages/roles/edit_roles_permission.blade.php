                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Edit Permissions to Roles</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-3">
                                                                ...
                                                                <div class="form-check mb-2 form-check-primary">
                                                                    <input class="form-check-input" type="checkbox" value="" id="customcheck1" {{ App\Models\User::roleHasPermissions($role, $permissions) ? 'checked' : '' }} >
                                                            ...
                                                            <div class="col-9">
                                                                ...
                                                                <div class="form-check mb-2 form-check-primary">
                                                                    <input class="form-check-input" type="checkbox" name="permission[]" {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }} value="{{ $permission->id }}" id="customcheck{{ $permission->id }}" >
