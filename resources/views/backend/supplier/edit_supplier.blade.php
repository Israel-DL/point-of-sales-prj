                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="POST" action="{{ route('supplier.update') }}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select @error('type') is-invalid @enderror" id="example-select" name="type">
                                                                    ...
                                                                    <option value="Whole Saler" {{ $supplier->type == 'Whole Saler' ? 'selected' : '' }}>Whole Saler</option>
                                                                </select>
                                                                @error('type')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="name" class="form-label">Account Holder</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="name" class="form-label">Bank Branch</label>
