...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Register & Signup | POS System</title>
                    ...
                    <div class="p-3">
                        ...
                        <form  method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" type="email" id="emailaddress" name="email" placeholder="Enter your email" required>
                                @error('email')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="Confirm your password">
                                    <div class="input-group-text" data-password="false">
                                        <span class="password-eye"></span>
                                    </div>
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">Already have account? <a href="{{ __('login') }}" class="text-muted ms-1"><b>Log In</b></a></p>
                        </footer>
