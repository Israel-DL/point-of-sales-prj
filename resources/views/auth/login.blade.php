                    ...
                    <div class="p-3">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" type="email" id="email" name="email" required="" placeholder="Enter your email" required>
                                @error('email')
                        ...
                        {{-- <footer class="footer footer-alt">
                            <p class="text-muted">Don't have an account? <a href="{{ __('register') }}" class="text-muted ms-1"><b>Sign Up</b></a></p>
                        </footer> --}}
